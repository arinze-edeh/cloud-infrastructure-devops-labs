...
***Screenshot: az --version output showing CLI version 2.67.0***
...
***Screenshot: echo $ACCOUNT_KEY confirming full base64 key was captured without truncation***
...
***Screenshots: diff command returning empty output confirming nautilus_source.txt and nautilus_dest.txt are byte-for-byte identical***
