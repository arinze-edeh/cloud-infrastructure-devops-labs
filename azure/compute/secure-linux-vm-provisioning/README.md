...
***Screenshots: Terminal showing `az resource list` output with only 4 networking resources remaining after cleanup***
...
***Screenshots: Terminal showing ssh-keygen randomart image output and successful PUB_KEY echo***
...
***Screenshot: Terminal showing `az account show` JSON output with `"state": "Enabled"`***
