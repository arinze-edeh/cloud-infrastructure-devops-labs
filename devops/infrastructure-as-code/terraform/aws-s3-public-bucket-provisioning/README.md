...
*Screenshots: Terminal output of `terraform plan` showing all four resources scheduled for creation and the `Plan: 4 to add` summary line*
...
*Screenshots: Terminal output of `terraform apply -auto-approve` showing all four resources created successfully with the `Apply complete! Resources: 4 added` summary line*
