...
*Screenshot: vi editor open with the completed playbook.yml content*
...
*Screenshot: vi editor open with the updated inventory showing ansible_become_pass added for all three hosts*
