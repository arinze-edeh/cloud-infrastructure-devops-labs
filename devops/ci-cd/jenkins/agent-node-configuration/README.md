...
<img width="541" height="863" alt="image" src="https://github.com/user-attachments/assets/f41a083e-9425-4b8e-bdd0-d0ce30769078" />


thor@jumphost ~$ ssh jenkins@jenkins
The authenticity of host 'jenkins (10.244.195.5)' can't be established.
...
jenkins@jenkins:~$ ssh-keygen -t rsa -b 4096 -C "jenkins-slave-key" -f ~/.ssh/jenkins_slave_rsa -N ""
...
|   o++o. .o.     |
+----[SHA256]-----+
jenkins@jenkins:~$ ssh-copy-id -f -i ~/.ssh/jenkins_slave_rsa.pub tony@stapp01
/usr/bin/ssh-copy-id: INFO: Source of key(s) to be installed: "/var/lib/jenkins/.ssh/jenkins_slave_rsa.pub"
The authenticity of host 'stapp01 (10.244.81.15)' can't be established.
...
jenkins@jenkins:~$ ssh tony@stapp01 "sudo dnf install -y java-17-openjdk && sudo mkdir -p /home/tony/jenkins && sudo chown tony:tony /home/tony/jenkins"
tony@stapp01's password: 
Last metadata expiration check: 3:33:46 ago on Sun Apr 26 06:08:27 2026.
...
(1/2): java-17-openjdk-17.0.18.0.8-2.el9.x86_64 681 kB/s | 428 kB     00:00    
(2/2): java-17-openjdk-headless-17.0.18.0.8-2.e  25 MB/s |  44 MB     00:01    
--------------------------------------------------------------------------------
Total                                            23 MB/s |  45 MB     00:01     
...
Complete!
jenkins@jenkins:~$ ssh-copy-id -f -i ~/.ssh/jenkins_slave_rsa.pub steve@stapp02
/usr/bin/ssh-copy-id: INFO: Source of key(s) to be installed: "/var/lib/jenkins/.ssh/jenkins_slave_rsa.pub"
The authenticity of host 'stapp02 (10.244.244.178)' can't be established.
ED25519 key fingerprint is SHA256:yEyN8qvzhNxfcKVE+H05zwQPmQMKCXj4JyGWuOP1HIg.
...
jenkins@jenkins:~$ ssh steve@stapp02 "sudo dnf install -y java-17-openjdk && sudo mkdir -p /home/steve/jenkins && sudo chown steve:steve /home/steve/jenkins"
steve@stapp02's password: 
Last metadata expiration check: 0:33:43 ago on Sun Apr 26 09:10:50 2026.
Dependencies resolved.
================================================================================
 Package                    Arch     Version                  Repository   Size
================================================================================
...
Installed size: 187 M
Downloading Packages:
(1/2): java-17-openjdk-17.0.18.0.8-2.el9.x86_64 1.4 MB/s | 428 kB     00:00    
(2/2): java-17-openjdk-headless-17.0.18.0.8-2.e  44 MB/s |  44 MB     00:00    
--------------------------------------------------------------------------------
...
Complete!
jenkins@jenkins:~$ ssh-copy-id -f -i ~/.ssh/jenkins_slave_rsa.pub banner@stapp03
/usr/bin/ssh-copy-id: INFO: Source of key(s) to be installed: "/var/lib/jenkins/.ssh/jenkins_slave_rsa.pub"
The authenticity of host 'stapp03 (10.244.234.222)' can't be established.
ED25519 key fingerprint is SHA256:yEyN8qvzhNxfcKVE+H05zwQPmQMKCXj4JyGWuOP1HIg.
This host key is known by the following other names/addresses:
    ~/.ssh/known_hosts:1: [hashed name]
...
jenkins@jenkins:~$ ssh banner@stapp03 "sudo dnf install -y java-17-openjdk && sudo mkdir -p /home/banner/jenkins && sudo chown banner:banner /home/banner/jenkins"
banner@stapp03's password: 
Last metadata expiration check: 3:42:37 ago on Sun Apr 26 06:04:27 2026.
Dependencies resolved.
================================================================================
 Package                    Arch     Version                  Repository   Size
================================================================================
...
Installed size: 187 M
Downloading Packages:
(1/2): java-17-openjdk-17.0.18.0.8-2.el9.x86_64 811 kB/s | 428 kB     00:00    
(2/2): java-17-openjdk-headless-17.0.18.0.8-2.e  25 MB/s |  44 MB     00:01    
--------------------------------------------------------------------------------
...
Complete!
jenkins@jenkins:~$ ssh -i ~/.ssh/jenkins_slave_rsa tony@stapp01 "java -version && echo 'tony OK'"
ssh -i ~/.ssh/jenkins_slave_rsa steve@stapp02 "java -version && echo 'steve OK'"
ssh -i ~/.ssh/jenkins_slave_rsa banner@stapp03 "java -version && echo 'banner OK'"
openjdk version "17.0.18" 2026-01-20 LTS
OpenJDK Runtime Environment (Red_Hat-17.0.18.0.8-2) (build 17.0.18+8-LTS)
...
OpenJDK 64-Bit Server VM (Red_Hat-17.0.18.0.8-2) (build 17.0.18+8-LTS, mixed mode, sharing)
banner OK
jenkins@jenkins:~$ cat ~/.ssh/jenkins_slave_rsa | base64 -w 0
@jenkins:~$ 
