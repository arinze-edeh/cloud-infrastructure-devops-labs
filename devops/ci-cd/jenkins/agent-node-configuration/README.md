...
>Screenshots: Jenkins credential form for "steve-key" showing username "steve" and the private key field populated, with "tony-key / tony" already visible in the credentials list background
