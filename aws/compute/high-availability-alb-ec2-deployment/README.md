...
> ***Screenshot Placeholder: cat -A output confirming clean Unix line endings with $ termination on each line***
...
> ***Screenshot Placeholder: create-listener output table showing listener ARN, HTTP, and port 80***
...
> ***Screenshot Placeholder: Full resource audit output showing all three sections with correct values***
...
> ***Screenshot Placeholder: Terminate, wait, and relaunch commands with new instance ID i-0ea7cfa8ef2a7756d returned***
