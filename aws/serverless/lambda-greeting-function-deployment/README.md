...
***Screenshot Placeholder: IAM "Select trusted entity" screen with `AWS service` selected and `Lambda` use case highlighted***
...
<img width="1801" height="947" alt="image" src="https://github.com/user-attachments/assets/a696be26-5f15-4671-b16e-e682ea089f42" />
