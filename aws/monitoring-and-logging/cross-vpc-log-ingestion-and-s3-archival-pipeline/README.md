...
> `Terminal showing crontab -l output on devops-priv-ec2 confirming the SCP cron entry is active`
...
> `Terminal showing crontab -l output on devops-pub-ec2 confirming the aws s3 cp cron entry is active with full S3 path`
...
> `Terminal showing aws s3 ls output with boots.log (23 bytes) at s3://devops-s3-logs-25406/devops-priv-vpc/boot/`
